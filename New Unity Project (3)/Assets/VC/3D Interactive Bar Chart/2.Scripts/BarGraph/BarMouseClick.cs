    ...
    public class BarMouseClick : MonoBehaviour
    {
       ...
       // bar = transform.parent.gameObject;
        ...
        public void OnMouseDown()
        {
            ...
            RecolorGrid recolor = new RecolorGrid();
            GameObject[] color = GameObject.FindGameObjectsWithTag("Grid");
            recolor.reColor(bar.GetComponent<BarProperty>().getGroupName(), color);
            
            //Debug.Log(bar.GetComponent<BarProperty>().GetBarLabel());
            Debug.Log(bar.GetComponent<BarProperty>().getGroupName());
            //Debug.Log(bar.GetComponent<BarProperty>().GetBarLabel());
